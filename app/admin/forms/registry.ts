...
export const FORM_REGISTRY: FormEntry[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { id: "nominee_location", label: "Where they're from", badge: "neutral" },
  ...
  },
  {
    ...
    columns: [
      ...
      { id: "availability", label: "Availability", badge: "red", headline: true },
      { id: "location", label: "Based in" },
      { id: "email", label: "Email", link: "mailto" },
      { id: "phone", label: "Phone", link: "tel" },
      { id: "note", label: "Note" },
    ],
    searchKeys: ["first_name", "last_name", "email", "availability", "location", "note"],
